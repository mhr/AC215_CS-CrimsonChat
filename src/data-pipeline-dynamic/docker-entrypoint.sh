...
# Bind the folder from the GCS bucket to /app/data
echo "Binding /mnt/gcs_bucket/$GCS_BUCKET_FOLDER to /app/gcp_dynamic_data "
mount --bind /mnt/gcs_bucket/$GCS_BUCKET_FOLDER /app/gcp_dynamic_data 
